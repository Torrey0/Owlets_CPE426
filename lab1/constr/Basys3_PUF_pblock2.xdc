...
###--------For LED Blink-------------_##
#set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets RO/osc[0]]
#set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets RO/oscDelayed[0]]
#set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets RO/ROFS/BxMux/muxOut]
...
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {genROs[*].RO/osc[0]}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {genROs[*].RO/oscDelayed[0]}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {genROs[*].RO/ROFS/BxMux/muxOut}]
...
set_property PACKAGE_PIN P1 [get_ports doneLED]
set_property IOSTANDARD LVCMOS33 [get_ports doneLED]
set_property PACKAGE_PIN L1 [get_ports hash_done]
set_property IOSTANDARD LVCMOS33 [get_ports hash_done]
...
add_cells_to_pblock [get_pblocks pblock_2] [get_cells -quiet [list {genROs[0].RO} {genROs[1].RO} {genROs[2].RO} {genROs[3].RO} {genROs[4].RO} {genROs[5].RO} {genROs[6].RO} {genROs[7].RO} {genROs[8].RO}]]
resize_pblock [get_pblocks pblock_2] -add {SLICE_X36Y128:SLICE_X55Y146}
resize_pblock [get_pblocks pblock_2] -add {DSP48_X1Y52:DSP48_X1Y57}
resize_pblock [get_pblocks pblock_2] -add {RAMB18_X1Y52:RAMB18_X1Y57}
resize_pblock [get_pblocks pblock_2] -add {RAMB36_X1Y26:RAMB36_X1Y28}
