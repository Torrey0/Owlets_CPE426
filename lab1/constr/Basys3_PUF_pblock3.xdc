...
add_cells_to_pblock [get_pblocks pblock_3] [get_cells -quiet [list {genROs[0].RO} {genROs[1].RO} {genROs[2].RO} {genROs[3].RO} {genROs[4].RO} {genROs[5].RO} {genROs[6].RO} {genROs[7].RO} {genROs[8].RO}]]
resize_pblock [get_pblocks pblock_3] -add {SLICE_X0Y80:SLICE_X15Y96}
resize_pblock [get_pblocks pblock_3] -add {DSP48_X0Y32:DSP48_X0Y37}
resize_pblock [get_pblocks pblock_3] -add {RAMB18_X0Y32:RAMB18_X0Y37}
resize_pblock [get_pblocks pblock_3] -add {RAMB36_X0Y16:RAMB36_X0Y18}
